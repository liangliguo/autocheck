...
_FIELD_SPECS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        key="AUTOCHECK_ENABLE_THINKING",
        attr_name="enable_thinking",
        group="模型策略",
        label="启用思考模式",
        control="boolean",
        value_type="bool",
        description="Qwen 等兼容接口通过 extra_body.enable_thinking 开启深度思考。",
        default=False,
    ),
    ConfigFieldSpec(
        key="AUTOCHECK_THINKING_BUDGET",
        attr_name="thinking_budget",
        group="模型策略",
        label="思考预算",
        control="number",
        value_type="int",
        description="Qwen 兼容接口的 thinking_budget；设为 0 表示不传该参数。",
        default=0,
        min_value=0,
        step="1",
    ),
    ConfigFieldSpec(
        key="AUTOCHECK_PRESERVE_THINKING",
        attr_name="preserve_thinking",
        group="模型策略",
        label="保留思考上下文",
        control="boolean",
        value_type="bool",
        description="Qwen 兼容接口通过 extra_body.preserve_thinking 保留多轮思考上下文。",
        default=False,
    ),
    ConfigFieldSpec(
